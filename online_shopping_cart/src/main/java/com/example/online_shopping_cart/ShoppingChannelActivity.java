...
import com.example.online_shopping_cart.util.ToastUtil;
...
public class ShoppingChannelActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void showGoods() {
        ...
        int sscreenWidch = getResources().getDisplayMetrics().widthPixels;
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(sscreenWidch / 2, ViewGroup.LayoutParams.WRAP_CONTENT);
